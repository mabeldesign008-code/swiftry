...
/// Extracted form widget matching the CreatePromotionForm Figma export.
/// Contains the 5-step form steps: type selection, discount, conditions,
/// usage limits, and valid period. Designed to be embedded in CreatePromotionScreen.
class CreatePromotionForm extends StatefulWidget {
  ...
  @override
  State<CreatePromotionForm> createState() => _CreatePromotionFormState();
}

class _CreatePromotionFormState extends State<CreatePromotionForm> {
  final List<Map<String, dynamic>> _promoTypes = [
    {'type': 'Percentage Discount', 'icon': LucideIcons.percent},
    {'type': 'Fixed Amount Off', 'icon': LucideIcons.minusSquare},
    {'type': 'Free Delivery', 'icon': LucideIcons.truck},
    {'type': 'BOGO (Buy 1 Get 1)', 'icon': LucideIcons.shoppingBag},
    {'type': 'Free Item with Purchase', 'icon': LucideIcons.gift},
  ];
      ...
      children: [
        ...
        Wrap(
          ...
          children: _promoTypes.map((pt) {
            final isSelected = widget.selectedType == pt['type'];
            return GestureDetector(
              onTap: () => widget.onTypeChanged?.call(pt['type'] as String),
              child: Container(
