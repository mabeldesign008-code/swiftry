  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create Story', style: AppTextStyles.heading2.copyWith(fontSize: 18)),
        centerTitle: true,
      ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('₵12.50', style: AppTextStyles.caption.copyWith(color: AppColors.textSecondary, fontSize: 10)),
                                    ],
                                  ),
                                ),
                                IconButton(
